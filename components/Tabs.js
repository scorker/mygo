  ...
  renderItem = (item) => {
    ...
    return (
      <Block style={styles.titleContainer}>
        ...
        <Animated.View useNativeDriver={true} style={{ height: 2, width, backgroundColor: materialTheme.COLORS.ACTIVE }} />
      </Block>
    )
  }
