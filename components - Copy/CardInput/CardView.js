...
export default class CardView extends Component {
  ...
  render() {
    const { focused,
      ...
      placeholder, imageFront, imageBack, scale, fontFamily, gaps } = this.props;
    ...
    if(number && gaps){
      formattedNumber = this.addGaps(formattedNumber, gaps);
    }
    return (
